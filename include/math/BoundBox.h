...
#ifdef cafe
static_assert(sizeof(BoundBox2f) == 0x10, "BoundBox2<T> size mismatch");
static_assert(sizeof(BoundBox3f) == 0x18, "BoundBox3<T> size mismatch");
#endif // cafe
