...
Model* ModelUtil::createG3d(const ModelResource& res, const sead::SafeString& name, s32 num_skl_anim, s32 num_tex_anim, s32 num_shu_anim, s32 num_vis_anim, s32 num_sha_anim, Model::BoundingMode bounding_mode, sead::Heap* heap)
{
    return createG3d(res, name, 1, num_skl_anim, num_tex_anim, num_shu_anim, num_vis_anim, num_sha_anim, bounding_mode, heap);
}

Model* ModelUtil::createG3d(const ModelResource& res, const sead::SafeString& name, s32 num_view, s32 num_skl_anim, s32 num_tex_anim, s32 num_shu_anim, s32 num_vis_anim, s32 num_sha_anim, Model::BoundingMode bounding_mode, sead::Heap* heap)
{
