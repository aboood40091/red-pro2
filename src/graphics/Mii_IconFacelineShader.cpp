...
void IconFacelineShader::initializeShader(agl::ShaderProgramArchive* p_archive)
{
...
void IconFacelineShader::setViewUniform(const rio::Matrix34f& view_mtx, const rio::Matrix44f& proj_mtx, const rio::Matrix34f& world_mtx) const
{
...
bool IconFacelineShader::activateTexture(const agl::TextureData& texture_data, Sampler sampler)
{
    ...
    return mTextureSampler[sampler].activate(mpShaderProgram->getSamplerLocationValidate(sampler), sampler);
}
