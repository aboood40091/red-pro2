...
PlayerBase::PlayerBase(const ActorCreateParam& param)
    ...
    , _25f0(0)
    , mWaterFunsuiEffect()
    , mWaterFunsuiEffectStep(0)
    , mWaterFunsuiEffectTimer(0)
    , mWaterEffect()
...
const f32 PlayerBase::cMaxFallSpeed = ACTOR_DEFAULT_MAX_FALL_SPEED;
const f32 PlayerBase::cMaxFallSpeed_Foot = ACTOR_DEFAULT_MAX_FALL_SPEED / 2;
